...
#define PACKET_STATUS 0
#define PACKET_CELL_VOLTAGE 2
#define PACKET_PERCENTAGE 3
#define PACKET_TEMPERATURE 4
#define PACKET_CURRENT 5
#define PACKET_BMS_SERIAL 6
